...
select
  'Coach Avery',
  'Owner / Head Trainer',
  'Coach Avery leads Dawg Training in Mooresville, helping athletes build strength, speed, agility, and confidence in a positive, high-energy room.',
...
select
  ...
  t.id,
  s.title,
  'Weekly group training at Dawg Training.',
  d.session_date,
  s.start_time,
  s.end_time,
  s.min_age,
